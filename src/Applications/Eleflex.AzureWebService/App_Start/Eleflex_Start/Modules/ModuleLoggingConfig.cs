...
namespace Eleflex.AzureWebService.App_Start.Eleflex_Start
{
    ...
    public class ModuleLoggingConfig : IStartupTask
    {
        ...
        {           
            ...
            properties.Add("Application", "ELEFLEX Azure Application");
            ...
            {                
                x.For<Eleflex.Logging.ILoggingStorageProvider>().Use<Eleflex.Logging.Storage.Azure.LoggingStorageProvider>()
