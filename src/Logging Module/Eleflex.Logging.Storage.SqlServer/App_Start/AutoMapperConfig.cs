...
using StorageModel = Eleflex.Logging.Storage.SqlServer.Model;
...
namespace Eleflex.Logging.Storage.SqlServer
{
    ...
    public class AutoMapperConfig : IMapCreator
    {
        ...
        {
            mapper.CreateMap<DomainModel.Log, StorageModel.Log>();
            mapper.CreateMap<StorageModel.Log, DomainModel.Log>();
        }
    }
}
