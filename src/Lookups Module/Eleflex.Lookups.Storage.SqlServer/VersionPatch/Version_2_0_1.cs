...
{
    /// <summary>
    /// The version patch for 2.0.1
    /// </summary>
    public class Version_2_0_1 : VersionModel.ModulePatch
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public override VersionModel.Version Version
        {
            get
            {
                return new VersionModel.Version(2, 0, 1, 0);
            }
        }
        ...
        public override List<VersionModel.Version> PriorVersions
        {
            get
            {
                return new List<VersionModel.Version>() { new VersionModel.Version(2, 0, 0, 0) };
            }
        }
