...
{
    /// <summary>
    /// The base version patch for 2.0.33
    /// </summary>
    public class Version_2_0_33 : VersionModel.ModulePatch
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_2_0_33()
        ...
        public override VersionModel.Version Version
        {
            get
            {
                return new VersionModel.Version(2, 0, 33, 0);
            }
        }
        ...
        public override List<VersionModel.Version> PriorVersions
        {
            get
            {
                ...
                {
                    new VersionModel.Version(2, 0, 32, 0)
                };
            }
        }
        ...
        {
            //This patch was to change web accountcontroller to disregard system user when determining if first registered user should be an admin (essentially no other users exist other then system account)
        }
