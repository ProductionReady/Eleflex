...
{
    /// <summary>
    /// Service command to create a User.
    /// </summary>
    [ServiceCommandHandlerAttribute(typeof(UserCreateRequest))]
    public class UserCreate : ServiceCommandHandler<UserCreateRequest, UserCreateResponse>
    {
