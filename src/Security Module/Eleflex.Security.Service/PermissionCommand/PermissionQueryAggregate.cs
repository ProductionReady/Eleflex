...
namespace Eleflex.Security.Service.PermissionCommand
{
    ...
    public class PermissionQueryAggregate : ServiceCommandHandler<PermissionQueryAggregateRequest, PermissionQueryAggregateResponse>
    {
        ...
        public PermissionQueryAggregate(IPermissionRepository permissionRepository)
        {
        ...
        public override void Execute(PermissionQueryAggregateRequest request, PermissionQueryAggregateResponse response)
        {
            response.Item = _permissionRepository.QueryAggregate(request);            
        }
    }
}
