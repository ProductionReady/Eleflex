...
{
    /// <summary>
    /// Service command to create a UserLogin.
    /// </summary>
    [ServiceCommandHandlerAttribute(typeof(UserLoginCreateRequest))]
    public class UserLoginCreate : ServiceCommandHandler<UserLoginCreateRequest, UserLoginCreateResponse>
    {
        ...
        public UserLoginCreate(IUserLoginRepository userLoginRepository)
        {
        ...
        public override void Execute(UserLoginCreateRequest request, UserLoginCreateResponse response)
        {
            DomainModel.UserLogin item = new DomainModel.UserLogin();
            ...
            item = _userLoginRepository.Insert(item);
