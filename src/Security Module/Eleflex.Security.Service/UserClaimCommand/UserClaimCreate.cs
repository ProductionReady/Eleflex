...
{
    /// <summary>
    /// Service command to create a UserClaim.
    /// </summary>
    [ServiceCommandHandlerAttribute(typeof(UserClaimCreateRequest))]
    public class UserClaimCreate : ServiceCommandHandler<UserClaimCreateRequest, UserClaimCreateResponse>
    {
        ...
        public UserClaimCreate(IUserClaimRepository userClaimRepository)
        {
        ...
        public override void Execute(UserClaimCreateRequest request, UserClaimCreateResponse response)
        {
            DomainModel.UserClaim item = new DomainModel.UserClaim();
            ...
            item = _userClaimRepository.Insert(item);
