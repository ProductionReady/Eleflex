...
{
    /// <summary>
    /// Service command to delete a UserClaim.
    /// </summary>
    [ServiceCommandHandlerAttribute(typeof(UserClaimDeleteRequest))]
    public class UserClaimDelete : ServiceCommandHandler<UserClaimDeleteRequest, UserClaimDeleteResponse>
    {
        ...
        public UserClaimDelete(IUserClaimRepository userClaimRepository)
        {
