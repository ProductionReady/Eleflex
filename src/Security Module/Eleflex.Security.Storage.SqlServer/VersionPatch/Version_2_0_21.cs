...
{
    /// <summary>
    /// The version patch for 2.0.21
    /// </summary>
    public class Version_2_0_21 : ModulePatch
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_2_0_21()
        ...
        public override VersionModel.Version Version
        {
            get
            {
                return new VersionModel.Version(2, 0, 21, 0);
            }
        }
        ...
        public override List<VersionModel.Version> PriorVersions
        {
            get
            {
                ...
                {
                    new VersionModel.Version(2,0,14,0)
                };
            }
        }
...
ALTER TABLE Eleflex.[Role] ADD [StartDate] [datetimeoffset](7) NULL;
ALTER TABLE Eleflex.[Role] ADD [EndDate] [datetimeoffset](7) NULL;
";
