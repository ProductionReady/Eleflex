...
{
    /// <summary>
    /// The version patch for 2.0.13
    /// </summary>
    public class Version_2_0_13 : ModulePatch
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_2_0_13()
        ...
        public override VersionModel.Version Version
        {
            get
            {
                return new VersionModel.Version(2, 0, 13, 0);
            }
        }
        ...
        public override List<VersionModel.Version> PriorVersions
        {
            get
            {
                ...
                {
                    new VersionModel.Version(2,0,12,0)
                };
            }
        }
...
ALTER TABLE Eleflex.[User] ALTER COLUMN FirstName NVARCHAR(50) NULL;
ALTER TABLE Eleflex.[User] ALTER COLUMN FirstName NVARCHAR(50) NULL;
ALTER TABLE Eleflex.[User] ALTER COLUMN LastName NVARCHAR(50) NULL;
ALTER TABLE Eleflex.[Role] ADD ModuleKey [uniqueidentifier] NULL;
ALTER TABLE Eleflex.[RoleRole] ADD ModuleKey [uniqueidentifier] NULL;
ALTER TABLE Eleflex.[RolePermission] ADD ModuleKey [uniqueidentifier] NULL;
EXEC sp_rename 'Eleflex.User.IsLockedOut', 'EnableLockout', 'COLUMN';
";
