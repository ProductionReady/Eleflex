...
namespace Eleflex.Versioning.Storage.Azure
{
    ...
    /// </summary>
    public class VersioningStorageProvider : SqlStorageProvider, IVersioningStorageProvider
    {
        ...
        public VersioningStorageProvider(string connectionStringKey, IStorageProviderUnitOfWork storageProviderUnitOfWork)
