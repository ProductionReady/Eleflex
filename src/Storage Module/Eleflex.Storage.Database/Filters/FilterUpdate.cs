...
namespace Eleflex.Storage.Database.Filters
{
    ...
    /// <summary>
    /// Defines an update filter item.
    /// </summary>
    public partial class FilterUpdate : FilterBase
    {
        ...
        public FilterUpdate(IEleflexProperty property)
        {
        ...
        {
            get { return FilterEnum.Update; }
        }

        /// <summary>
        /// Determines if used in the update clause.
        /// </summary>
        public override bool IsUpdateClause
        {
            get { return true; }
        }
