...
namespace Eleflex.Storage.Database.Filters
{
    ...
    /// </summary>
    public partial class Select : FilterSelect, IDatabaseFilter
    {

        /// <summary>
        /// Constant used for logging.
        /// </summary>
        public const string CLASSNAME = "PR.Eleflex.Persistence.Database.TSQL.Select" + EleflexProperty.Field_Seperator;
        ...
        public Select(IEleflexProperty property) :
            base(property)
        { }
        ...
        public Select(FilterSelect filter) :
