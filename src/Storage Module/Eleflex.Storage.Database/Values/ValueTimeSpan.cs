...
namespace Eleflex.Storage.Database.Values
{
    ...
    /// </summary>
    public partial class ValueTimeSpan : ValueBase<TimeSpan>
    {

        /// <summary>
        /// The default value of the data type.
        /// </summary>
        public static TimeSpan DefaultValue = new TimeSpan();


        /// <summary>
        /// Constructor.
        /// </summary>
        public ValueTimeSpan() : this(DefaultValue) { }

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="value"></param>
        public ValueTimeSpan(TimeSpan value)
        {
            _dataTypeName = EleflexDataTypeConstant.TimeSpan;
            _isNullable = false;
            _value = value;
        }
        ...
        /// <returns></returns>
        public static bool Convert(IEleflexDataType input, ref TimeSpan output)
        {
            if (input == null)
                return false;

            if (input.DataTypeName == EleflexDataTypeConstant.TimeSpan)
            {
                output = (input as ValueTimeSpan).Value;
                return true;
            }
        ...
        /// <param name="output"></param>
        /// <returns></returns>
        public static bool ConvertObject(object input, ref TimeSpan output)
        {
            if (input == null)
                return false;
