...
namespace Eleflex.Storage.Database.Values
{
    ...
    /// </summary>
    public partial class ValueDecimalNull : ValueBase<Nullable<Decimal>>
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        public ValueDecimalNull() : this(null) { }

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="value"></param>
        public ValueDecimalNull(Nullable<Decimal> value)
        {
            _dataTypeName = EleflexDataTypeConstant.DecimalNull;
            _isNullable = true;
            _value = value;
        }
        ...
        /// <returns></returns>
        public static bool Convert(IEleflexDataType input, ref Nullable<Decimal> output)
        {
            if (input == null)
            {
                output = new Nullable<Decimal>();
                return true;
            }

            if (input.DataTypeName == EleflexDataTypeConstant.DecimalNull)
            {
                output = (input as ValueDecimalNull).Value;
                return true;
            }
        ...
        /// <param name="output"></param>
        /// <returns></returns>
        public static bool ConvertObject(object input, ref Nullable<Decimal> output)
        {
            if (input == null)
            {
                output = new Nullable<Decimal>();
            ...
            {
                output = new Nullable<Decimal>(temp);
                return true;
            }
            return false;
        }
            ...
            out IEleflexDataType output)
        {
            ...
            {
                output = new ValueDecimalNull(null);
                return true;
            }
            ...
            {
                output = new ValueDecimalNull(temp);
                return true;
            }
            return false;
        }
