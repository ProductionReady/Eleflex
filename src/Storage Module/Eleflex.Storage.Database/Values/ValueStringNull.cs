...
namespace Eleflex.Storage.Database.Values
{
    ...
    /// </summary>
    public partial class ValueStringNull : ValueBase<String>
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        public ValueStringNull() : this(null) { }

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="value"></param>
        public ValueStringNull(String value)
        {
            _dataTypeName = EleflexDataTypeConstant.StringNull;
            _isNullable = true;
            _value = value;
        }
        ...
        /// <returns></returns>
        public static bool Convert(IEleflexDataType input, ref String output)
        {
            if (input == null)
            {
                output = null;
            ...
            if (input.DataTypeName == EleflexDataTypeConstant.StringNull)
            {
                output = (input as ValueStringNull).Value;
                return true;
            }
        ...
        /// <param name="output"></param>
        /// <returns></returns>
        public static bool ConvertObject(object input, ref String output)
        {
            if (input == null)
            {
                output = null;
        ...
        {
            output = new ValueStringNull(input);
            return true;
        }
