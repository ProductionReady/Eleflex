...
namespace Eleflex.Storage.Database.Values
{
    ...
    /// </summary>
    public partial class ValueDateTimeNull : ValueBase<Nullable<DateTime>>
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        public ValueDateTimeNull() : this(null) { }

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="value"></param>
        public ValueDateTimeNull(Nullable<DateTime> value)
        {
            _dataTypeName = EleflexDataTypeConstant.DateTimeNull;
            _isNullable = true;
            _value = value;
        }
        ...
        /// <returns></returns>
        public static bool Convert(IEleflexDataType input, ref Nullable<DateTime> output)
        {
            if (input == null)
            {
                output = new Nullable<DateTime>();
                return true;
            }
            if (input.DataTypeName == EleflexDataTypeConstant.DateTimeNull)
            {
                output = (input as ValueDateTimeNull).Value;
                return true;
            }
        ...
        /// <param name="output"></param>
        /// <returns></returns>
        public static bool ConvertObject(object input, ref Nullable<DateTime> output)
        {
            if (input == null)
            {
                output = new Nullable<DateTime>();
            ...
            {
                output = new Nullable<DateTime>(temp);
                return true;
            }
            return false;
        }
            ...
            out IEleflexDataType output)
        {
            ...
            {
                output = new ValueDateTimeNull(null);
                return true;
            }
            ...
            {
                output = new ValueDateTimeNull(temp);
                return true;
            }
            return false;
        }
