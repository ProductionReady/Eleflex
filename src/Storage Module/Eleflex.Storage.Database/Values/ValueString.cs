...
namespace Eleflex.Storage.Database.Values
{
    ...
    /// </summary>
    public partial class ValueString : ValueBase<String>
    {
        ...
        /// Constructor.
        /// </summary>
        public ValueString() : this(DefaultValue) { }
        ...
        {
            _dataTypeName = EleflexDataTypeConstant.String;
            _isNullable = false;
            _value = value;
        }
        ...
        public static bool Convert(IEleflexDataType input, ref String output)
        {
            ...
            if (input.DataTypeName == EleflexDataTypeConstant.String)
            {
                output = (input as ValueString).Value;
                return true;
            }
