...
namespace Eleflex.Storage.Database.Values
{
    ...
    /// </summary>
    public partial class ValueByte : ValueBase<Byte>
    {

        /// <summary>
        /// The default value of the data type.
        /// </summary>
        public const Byte DefaultValue = 0;


        /// <summary>
        /// Constructor.
        /// </summary>
        public ValueByte() : this(DefaultValue) { }
        ...
        {
            _dataTypeName = EleflexDataTypeConstant.Byte;
            _isNullable = false;
            _value = value;
        }
        ...
        public static bool Convert(IEleflexDataType input, ref Byte output)
        {
            ...
            if (input.DataTypeName == EleflexDataTypeConstant.Byte)
            {
                output = (input as ValueByte).Value;
                return true;
            }
        ...
        public static bool ConvertObject(object input, ref Byte output)
        {
            if (input == null)
                return false;
            return Byte.TryParse(input.ToString(), out output);
        }
