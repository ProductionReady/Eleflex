...
namespace Eleflex.Storage.Database.Values
{
    ...
    /// </summary>
    public partial class ValueObject : ValueBase<object>
    {
        ...
        /// Constructor.
        /// </summary>
        public ValueObject() : this(new object()) { }
        ...
        {
            _dataTypeName = EleflexDataTypeConstant.Object;
            _isNullable = false;
            _value = value;
        }
        ...
        public static bool Convert(IEleflexDataType input, ref object output)
        {
            ...
            if (input.DataTypeName == EleflexDataTypeConstant.Object)
            {
                output = (input as ValueObject).Value;
                return true;
            }
