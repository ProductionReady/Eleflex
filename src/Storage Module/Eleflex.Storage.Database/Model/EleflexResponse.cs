...
namespace Eleflex.Storage.Database
{
    ...
    /// </summary>
    public partial class EleflexResponse : EleflexContext, IEleflexResponse
    {

        /// <summary>
        /// The unique key used to distinguish this object from others.
        /// </summary>
        public new const string EleflexObjectKey = "PR.Eleflex.EleflexResponse" + EleflexProperty.Field_Seperator;


        /// <summary>
        /// Constructor.
        /// </summary>
        public EleflexResponse() : base() 
        {
