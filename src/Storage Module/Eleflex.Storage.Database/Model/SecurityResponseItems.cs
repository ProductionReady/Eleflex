...
namespace Eleflex.Storage.Database
{
    ...
    public partial class SecurityResponseItems<T1> : SecurityResponse, ISecurityResponseItems<T1>
    {

        /// <summary>
        /// The unique key used to distinguish this object from others.
        /// </summary>
        public new const string EleflexObjectKey = "PR.Eleflex.Security.SecurityResponseItems" + EleflexProperty.Field_Seperator;
        /// <summary>
        ...
        public SecurityResponseItems(List<T1> items)
            : base()
        {
            _eleflexObjectKey = EleflexObjectKey;
            Items = items;
