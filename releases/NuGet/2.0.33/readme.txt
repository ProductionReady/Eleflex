...
Issues Fixed:
* Added user role assignment to system account
* Change Account Login to disregard system user to determine if to make first registered user an admin
