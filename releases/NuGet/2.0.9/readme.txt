...
--------------------
* NuGet installation changes to add dependent framework assemblies for new installations
* NuGet install - removed web.config.uninstall.xdt, so configurations aren't lost when upgrading
* Logging Module - added Source and Exception properties to Log object (verifying versioning upgrade process)
* Logging Module - updated Admin System Log page to reflect searching and displaying all properties
* Admin Module - updates to routing to remove absolute paths (in case of route renames)
* Lookups Module - added list and stubbed simple create view (not complete yet)
* System styles - add primary color to table headers, error validators with integration to bootstrap
* System styles and scripts - prefixed with "eleflex" to denote ownership / integration / customization points
* Code comments and license headers several places
