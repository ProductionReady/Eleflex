...
---------------------
We are proud to officially release our next generation platform, ELEFLEX v2.1.0!
...
-----------------------------
It is recommended that you create a new Visual Studio 2013 ASP.NET MVC 4 Web Application (Empty Template), then add the ELEFLEX package. 

The following steps must be completed to finish setup of a new ELEFLEX default installation:
