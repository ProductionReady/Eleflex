...
--------------------
v2.0.23 Release Notes
--------------------
* Enable administration of security for users, roles, permissions and claims
* Removed NuGet package for Bootstrap.v3.Datetimepicker.CSS for displaying dates in the application
* Added NuGet package for smalot.bootstrap-datetimepicker for displaying dates in the application
* Updated the installed components page in admin developer tools to reflect all current components and versions
