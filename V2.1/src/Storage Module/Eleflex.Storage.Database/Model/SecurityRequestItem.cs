...
namespace Eleflex.Storage.Database
{
    ...
    /// </summary>
    public partial class SecurityRequestItem<T1> : SecurityRequest, ISecurityRequestItem<ISecurityContext, T1>
    {

        /// <summary>
        /// The unique key used to distinguish this object from others.
        /// </summary>
        public new const string EleflexObjectKey = "PR.Eleflex.Security.SecurityRequestItem" + EleflexProperty.Field_Seperator;
        ...
        /// Constructor.
        /// </summary>
        public SecurityRequestItem() : this(default(T1)) { }
        
        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="item"></param>
        public SecurityRequestItem(T1 item) : base()
        {
        ...
        {
            return new SecurityRequestItem<T1>();
        }
        ...
        public override void EleflexInitialize()
        {
            ...
            EleflexSetPropertyValue(
                ...
                new EleflexProperty(this, 3, _Item, EleflexDataTypeConstant.Custom, true));
