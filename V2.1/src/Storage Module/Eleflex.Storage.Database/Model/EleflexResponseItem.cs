...
namespace Eleflex.Storage.Database
{
    ...
    public partial class EleflexResponseItem<T1> : EleflexResponse, IEleflexResponseItem<T1>
    {

        /// <summary>
        /// The unique key used to distinguish this object from others.
        /// </summary>
        public new const string EleflexObjectKey = "PR.Eleflex.EleflexResponseItem" + EleflexProperty.Field_Seperator;
        /// <summary>
        ...
        /// Constructor.
        /// </summary>
        public EleflexResponseItem() : base()
        {
        ...
        public EleflexResponseItem(T1 item) : base()
        {
            _eleflexObjectKey = EleflexObjectKey;
            Item = item;
        }
