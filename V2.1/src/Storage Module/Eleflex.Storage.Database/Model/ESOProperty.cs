...
namespace Eleflex.Storage.Database
{
    ...
    /// </summary>
    public partial class ESOProperty : EBOProperty, IESOProperty
    {        

        /// <summary>
        /// Constructor.
        /// </summary>
        public ESOProperty():base() { }
        ...
        public ESOProperty(
            ...
            bool isAuditUpdate,
            bool isSecurityUser)
            : base(parentObject, ordinal, name, dataTypeName, isNullable, isKey, isComputed, maxLength, precision, scale, isConcurrency, isAuditInsert, isAuditUpdate)
        {
            IsAuditSecurityUser = isSecurityUser;
        }

        /// <summary>
        /// The user key.
        /// </summary>
        public virtual bool IsAuditSecurityUser { get; set; } 
