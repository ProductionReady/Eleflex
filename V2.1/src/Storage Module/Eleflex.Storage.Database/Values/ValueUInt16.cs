...
namespace Eleflex.Storage.Database.Values
{
    ...
    /// </summary>
    public partial class ValueUInt16 : ValueBase<UInt16>
    {

        /// <summary>
        /// The default value of the data type.
        /// </summary>
        public const UInt16 DefaultValue = 0;


        /// <summary>
        /// Constructor.
        /// </summary>
        public ValueUInt16() : this(DefaultValue) { }

        /// <summary>
        /// Constructor.
        /// </summary>
        /// <param name="value"></param>
        public ValueUInt16(UInt16 value)
        {
            _dataTypeName = EleflexDataTypeConstant.UInt16;
            _isNullable = false;
            _value = value;
        }
        ...
        /// <returns></returns>
        public static bool Convert(IEleflexDataType input, ref UInt16 output)
        {
            if (input == null)
                return false;

            if (input.DataTypeName == EleflexDataTypeConstant.UInt16)
            {
                output = (input as ValueUInt16).Value;
                return true;
            }
        ...
        /// <param name="output"></param>
        /// <returns></returns>
        public static bool ConvertObject(object input, ref UInt16 output)
        {
            if (input == null)
                return false;
            return UInt16.TryParse(input.ToString(), out output);
        }
