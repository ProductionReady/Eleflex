...
{
    /// <summary>
    /// Service command to query UserLogins for aggregate.
    /// </summary>
    [ServiceCommandHandlerAttribute(typeof(UserLoginQueryAggregateRequest))]
    public class UserLoginQueryAggregate : ServiceCommandHandler<UserLoginQueryAggregateRequest, UserLoginQueryAggregateResponse>
    {
        ...
        public UserLoginQueryAggregate(IUserLoginRepository userLoginRepository)
        {
