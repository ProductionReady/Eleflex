...
namespace Eleflex.Logging.Storage.SqlServer
{
    ...
    /// </summary>
    public class LoggingStorageProvider : EntityStorageProvider, ILoggingStorageProvider
    {        
        /// <summary>
        /// Constructor.
        /// </summary>
        ...
        public LoggingStorageProvider(string connectionStringKey, IStorageProviderUnitOfWork storageProviderUnitOfWork)
            :base(Eleflex.Logging.LoggingConstants.STORAGE_PROVIDER_NAME, connectionStringKey, storageProviderUnitOfWork)
        {
        }
