...
{
    /// <summary>
    /// The base version patch for 2.0.35
    /// </summary>
    public class Version_2_0_35 : VersionModel.ModulePatch
    {
        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_2_0_35()
        ...
        public override List<Guid> DependentModules
        {
            get
            {
                return new List<Guid> { 
                    ...
                    LoggingConstants.STORAGE_PROVIDER_MODULE_KEY
                };
            }
        }
        ...
        public override VersionModel.Version Version
        {
            get
            {
                return new VersionModel.Version(2, 0, 35, 0);
            }
        }
        ...
        public override void Update()
        {
            ...
            // Added configuring severity levels of logging adapters
        }
