...
{
    /// <summary>
    /// Represents an object used to assemble storage query filter expressions.
    /// </summary>
    public partial class StorageQueryBuilder : IStorageQueryBuilder
    {
        ...
        {
            return new StorageQuery() { StorageQueryFilters = this.Filters, PagingNumberPerPage = this.NumberPerPage, PagingStartPage = this.StartPage };
        }
