...
using Eleflex.Web;
using Eleflex.Security.Web.Account.Models;
using Eleflex.Security.Services.WCF.Message;

namespace Eleflex.Security.Web.Account.Controllers
{
    /// <summary>
    /// Account.
    /// </summary>
    ...
    public class AccountController : Controller
    {
        ...
        protected IdentitySignInManager _signInManager;
        protected IdentityUserManager _userManager;
        protected IRepository<IdentityUser, Guid> _securityUserServiceRepository = null;
            ...
            IMappingService mappingService)
        {
            ...
            _securityUserServiceRepository = userServiceRepository;
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {                    
                    ...
                    builder.Aggregate("SecurityUserKey", StorageQueryAggregateType.Count);
                    builder.IsEqual("Active", true.ToString());
                    builder.IsNotEqual("SecurityUserKey", SecurityConstants.USERKEY_SYSTEM_ADMIN.ToString());
                    using (ImpersonateSystem impersonate = new ImpersonateSystem())
                    {
                        var resp = _securityUserServiceRepository.QueryAggregate(new RequestItem<IStorageQuery>() { Item = builder.GetStorageQuery() });
                ...
                if (result.Succeeded)
                {
                    ...
                    UserManager.AddToRole(user.SecurityUserKey.ToString(), SecurityConstants.ROLE_USER);                                            
                    ...
                    {
                        //Add to admin role
                        UserManager.AddToRole(user.SecurityUserKey.ToString(), SecurityConstants.ROLE_ADMIN);
        ...
        public async Task<ActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                await UserManager.SendEmailAsync(user.Id, "Password Reset Request", "Please reset your password by clicking " + callbackUrl);
