...
namespace Eleflex.Versioning.Storage.EF.Azure
{
    ...
    public class Version_3_0_0_0 : VersioningModel.ModulePatch
    {
        ...
        public Version_3_0_0_0()
            : base(VersioningConstants.STORAGE_SERVICE_MODULE_KEY, VersioningAzureConstants.MODULE_NAME, VersioningAzureConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
        ...
        {
            get { return ObjectLocator.Current.GetInstance<IVersioningStorageService>().VersioningStorageConfig == VersioningAzureConstants.VERSIONING_STORAGE_CONFIG; }
        }
...
END
/****** Object:  Table [EleflexV3].[Module]    Script Date: 8/29/2015 11:30:28 AM ******/
SET ANSI_NULLS ON
;
