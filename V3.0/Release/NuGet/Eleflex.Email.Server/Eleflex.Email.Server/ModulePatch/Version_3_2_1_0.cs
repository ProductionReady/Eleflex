...
namespace Eleflex.Email.WebServer
{
    ...
    public class Version_3_2_1_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates the Eleflex.Email.Server library.";

        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_3_2_1_0()
            : base(EleflexEmailServerConstants.MODULE_KEY, EleflexEmailServerConstants.MODULE_NAME, EleflexEmailServerConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
