...
namespace Eleflex.Server
{
    ...
    public class Version_3_1_0_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates the Eleflex.Server library. This release added the NuGet packages for Eleflex.Storage.EntityFramework and Eleflex.Server.";

        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_3_1_0_0()
            : base(EleflexServerConstants.MODULE_KEY, EleflexServerConstants.MODULE_NAME, EleflexServerConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
