...
namespace Eleflex.Email.Messages
{
    /// <summary>
    ...
    public class Version_3_2_1_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates the Eleflex.Email.Messages library.";

        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_3_2_1_0()
            : base(EleflexEmailMessagesConstants.MODULE_KEY, EleflexEmailMessagesConstants.MODULE_NAME, EleflexEmailMessagesConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
