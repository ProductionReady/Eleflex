...
{
    class ServerFileSQLServerPatch : IGenerate
    {
        ...
        public ServerFileSQLServerPatch(string namespaceName, Eleflex.Version versionNumber, string moduleName)
        {
...
namespace " + _namespace + @"
{
    ...
    public class Version_" + _versionNumber.ToString().Replace(".", "_") + @" : VersioningModel.ModulePatch
    {
        ...
        public Version_" + _versionNumber.ToString().Replace(".", "_") + @"()
            : base(" + _moduleName + @"SQLServerConstants.MODULE_KEY, " + _moduleName + @"SQLServerConstants.MODULE_NAME, " + _moduleName + @"SQLServerConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
        ...
        {
            get { return ObjectLocator.Current.GetInstance<I" + _moduleName + @"StorageService>().VersioningStorageConfig == " + _moduleName + @"SQLServerConstants.VERSIONING_STORAGE_CONFIG; }
        }
