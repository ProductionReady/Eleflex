...
{
    class ServerFileServicesAutomapperCodeGenTT : IGenerate
    {
        ...
        public ServerFileServicesAutomapperCodeGenTT(string namespaceprefix, string rootNamespace, string moduleName, string namespaceName, string efName, string namespaceServer)
        {
...
{    
	...
	fileManager.StartNewFile(customEntityName + ""ServiceAutoMapperRegistrationTask.cs"");
...
{
	/// <summary>
    /// Represents a mapping registration task for mapping between the <#=customEntityName#> domain and a <#=entity.Name#> service object.
    /// </summary>
	...
	{	
        ...
        {
            Description = ""This task registers mapping between the <#=customEntityName#> domain and a <#=entity.Name#> service object."";
        }
        ...
        {
            Mapper.CreateMap<DomainModel.<#=customEntityName#>, ServiceModel.<#=customEntityName#>>();
            Mapper.CreateMap<ServiceModel.<#=customEntityName#>, DomainModel.<#=customEntityName#>>();
