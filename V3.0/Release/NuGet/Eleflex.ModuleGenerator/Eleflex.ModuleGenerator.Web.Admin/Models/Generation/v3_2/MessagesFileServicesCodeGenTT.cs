...
{
    class MessagesFileServicesCodeGenTT : IGenerate
    {
        ...
        public MessagesFileServicesCodeGenTT(string rootNamespace, string moduleName, string namespaceName, string efName, string namespaceServer)
        {
...
var customNamespace = """ + _rootNamespace + @".Services.WCF.Message"";
