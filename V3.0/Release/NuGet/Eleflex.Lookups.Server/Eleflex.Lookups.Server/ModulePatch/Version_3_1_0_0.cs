...
namespace Eleflex.Lookups.WebServer
{
    ...
    public class Version_3_1_0_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates the Eleflex.Lookups.Server library. This release added the NuGet package for Lookups.Server.";

        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_3_1_0_0()
            : base(EleflexLookupsServerConstants.MODULE_KEY, EleflexLookupsServerConstants.MODULE_NAME, EleflexLookupsServerConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
