...
namespace Eleflex.Storage.EntityFramework
{
    ...
    public class Version_3_2_0_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates the Eleflex.Storage.EntityFramework library. This release added the NuGet packages for Eleflex.Web.";
