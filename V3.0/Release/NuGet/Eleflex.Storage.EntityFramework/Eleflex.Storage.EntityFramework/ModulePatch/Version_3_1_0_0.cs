...
{
    /// <summary>
    /// The base version patch for 3.1.0.0
    /// </summary>
    public class Version_3_1_0_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates the Eleflex.Storage.EntityFramework library. This release added the NuGet packages for Eleflex.Storage.EntityFramework and Eleflex.Server.";

        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_3_1_0_0()
            : base(EleflexStorageEntityFrameworkConstants.MODULE_KEY, EleflexStorageEntityFrameworkConstants.MODULE_NAME, EleflexStorageEntityFrameworkConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
