...
namespace $rootnamespace$.App_Start.Eleflex_Start.EleflexEmail
{
    ...
    public partial class WebClientObjectLocationRegistrationTask : RegistrationTask
    {
        ...
        public override bool Register(ITaskOptions taskOptions)
        {
            ...
            {
                //Change ASP.NET OWIN email messaging service to use business repository
                x.For<IEmailIdentityMessageService>().Use<Eleflex.Email.WebServer.EmailIdentityMessageBusinessRepositoryService>()
