...
namespace Eleflex.Email.WebServer
{
    ...
    public class Version_3_2_0_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates the Eleflex.Email.WebServer component. This release added the NuGet package for Email.Server.";

        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_3_2_0_0()
            : base(EleflexEmailWebServerConstants.MODULE_KEY, EleflexEmailWebServerConstants.MODULE_NAME, EleflexEmailWebServerConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
