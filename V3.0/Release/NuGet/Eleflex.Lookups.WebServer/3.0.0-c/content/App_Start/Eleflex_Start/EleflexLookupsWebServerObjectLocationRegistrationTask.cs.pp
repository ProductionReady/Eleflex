...
namespace $rootnamespace$.App_Start.Eleflex_Start
{
    ...
    public partial class EleflexLookupsWebServerObjectLocationRegistrationTask : RegistrationTask
    {

        /// <summary>
        /// Constructor.
        /// </summary>
        public EleflexLookupsWebServerObjectLocationRegistrationTask()
        {
