...
namespace Eleflex.Lookups.WebServer
{
    ...
    public class Version_3_1_0_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates the Eleflex.Lookups.WebServer component. This release added the NuGet package for Lookups.Server.";

        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_3_1_0_0()
            : base(EleflexLookupsWebServerConstants.MODULE_KEY, EleflexLookupsWebServerConstants.MODULE_NAME, EleflexLookupsWebServerConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
