...
namespace Eleflex.WebClient
{
    ...
    public class Version_3_1_0_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates Eleflex.WebClient component. This release added the NuGet packages for Eleflex.Storage.EntityFramework and Eleflex.Server.";

        /// <summary>
        /// Constructor.
        /// </summary>
        public Version_3_1_0_0()
            : base(EleflexWebClientConstants.MODULE_KEY, EleflexWebClientConstants.MODULE_NAME, EleflexWebClientConstants.MODULE_DESCRIPTION, PATCH_INFO)
        {
        }
