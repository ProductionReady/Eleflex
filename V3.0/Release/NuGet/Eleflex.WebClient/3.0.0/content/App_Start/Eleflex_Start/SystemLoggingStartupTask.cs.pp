...
using Eleflex.Logging.CommonLogging.WCF;
...
namespace $rootnamespace$.App_Start.Eleflex_Start
{
    ...
    public partial class SystemLoggingStartupTask : StartupTask
    {
        ...
        public override bool Start(ITaskOptions taskOptions)
        {
            ...
            properties.Add(LoggingConstants.CONFIGPARAM_APPLICATION, "ELEFLEX Web Client Application");
            ...
            Common.Logging.LogManager.Adapter = new CommonLoggingFactoryAdapterServiceRepository(properties);

            //Swap existing log provider
            ILogService existingProvider = Logger.Current;
            Logger.Current = new CommonLoggingService();
