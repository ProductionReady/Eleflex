...
ELEFLEX is a platform for building modular, domain-driven, service-oriented web applications and services. This package contains WCF service commands and database classes for the Logging, Security and Versioning core modules using Microsoft SQL Server and Azure database platforms.
