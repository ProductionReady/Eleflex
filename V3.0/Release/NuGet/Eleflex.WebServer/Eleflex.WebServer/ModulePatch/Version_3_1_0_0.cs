...
namespace Eleflex.WebServer
{
    ...
    public class Version_3_1_0_0 : VersioningModel.ModulePatch
    {
        ...
        /// </summary>
        protected const string PATCH_INFO = "This patch updates Eleflex.WebServer library. This release added the NuGet packages for Eleflex.Storage.EntityFramework and Eleflex.Server.";
