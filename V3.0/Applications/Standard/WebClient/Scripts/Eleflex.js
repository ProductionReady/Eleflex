...
function eleflexHandleAjaxResponse(result, onsuccess) {
    ...
    if(ajaxResponse.Status && ajaxResponse.Message)
    {
        if (ajaxResponse.Status == "success") {
            eleflexShowSuccessMessage(ajaxResponse.Message);
        }
        if (ajaxResponse.Status == "info") {
            eleflexShowInfoMessage(ajaxResponse.Message);
        }
        if (ajaxResponse.Status == "warning") {
            eleflexShowWarnMessage(ajaxResponse.Message);
        }
        if (ajaxResponse.Status == "error") {
            eleflexShowErrorMessage(ajaxResponse.Message);
        }
    }
...
function eleflexShowWarnMessage(message) {
